  ...
  allSources = {
    letoram-arcan = {
      ...
      src = fetchFromGitHub {
        ...
        repo = "dummy";
        rev = "395d1596515423b9bb75565ced496b67e0f3c105";
        hash = "sha256-rQ40lc/13oN1Nkxs+07zvHVlBFn0DIZbYhHuxTl3pwg=";
      };
    };
...
stdenv.mkDerivation (finalAttrs: {
  ...
  cmakeFlags = [
    ...
    (lib.cmakeFeature "ENGINE_BUILDTAG" "OK")
