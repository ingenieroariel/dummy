{ stdenv, lib, fetchurl, fetchFromGitHub, fetchpatch, fetchCrate, buildPackages
, meson, pkg-config, ninja, zlib
...
let
  version = "24.0.1";
  hash = "sha256-87cZKwjEccVFWQ3RIjCio0MkSAS1/oZv7GrqAuq1dhM=";
...
self = stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    owner = "ingenieroariel";
    repo = "dummy";
    rev = "5ceb8367e95ad87a3f092f9361a8c79897cc0d38";
  hash = "sha256-qkGqaF9EHtzDK5hYHgv/StjP33jybYhp0fLeoF3gCro=";
  };

  sourceRoot = "source/mesa";
  patches = [
    ./opencl.patch
  ...
  outputs = [ "out" "dev" "drivers" ]
    ++ lib.optional false "osmesa"
    ++ lib.optional stdenv.isLinux "driversdev"
    ++ lib.optional false "opencl"
  ...
  mesonFlags = [
    ...
    "-Dgallium-nine=${lib.boolToString false}" # Direct3D in Wine
    "-Dosmesa=${lib.boolToString false}" # used by wine
  ...
  buildInputs = with xorg; [
    zlib
    expat glslang libglvnd xorgproto
    ...
    ++ lib.optionals true [ llvmPackages.libclc llvmPackages.clang llvmPackages.clang-unwrapped spirv-llvm-translator ]
    ++ lib.optional withValgrind valgrind-light
    ++ lib.optional haveZink vulkan-loader
    ++ lib.optional true directx-headers;
